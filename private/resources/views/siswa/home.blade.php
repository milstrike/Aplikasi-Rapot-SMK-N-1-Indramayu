                ...
                <div class="span2">
                    <div>
                        <ul class="nav nav-pills nav-stacked">
                            <li class="active"><a href="siswa"><small>Dashboard</small></a></li>
                    ...
                    <div class="paneleverything">
                        <div>
                            @if($datanilai->count()>0)
                                <h3>Nilai Tahun Ajaran Saat Ini: {{ $datanilai -> first() -> tahun_ajaran}}</h3>
                            @else
                                <h3>Nilai Tahun Ajaran Saat Ini: (Tidak ada data rapot)</h3>
                            @endif
