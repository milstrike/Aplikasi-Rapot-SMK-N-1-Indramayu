        ...
        <div class="row-fluid">
            ...
            <div class="span4 paneleverything">
                <div class="well" style="background-color: #ffffff;">
                    <h3>Login Wali Kelas</h3>
                    <form method="POST" enctype="multipart/form-data" action="loginwalikelas">	
                        ...
                        @endif
                        <input type="submit" class="btn btn-primary pull-right" value="Masuk ke Sistem" id="auth_check" name="auth_check" /></<br/><br/>
                    </form>
                    <ul class="unstyled">
